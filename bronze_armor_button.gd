...
@export var item_name := "Bronze Armor"
@export var item_desc := "Heavy, large, and strong, this armor gives you 25% protection during battles!"
@export var item_price := 15000
@export var item_id := ""
